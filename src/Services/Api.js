...
class Api {
  ...
  postCampaign(body){
    return this.api.post(`create_campaign`, {
      campaignName: body.campaignName,
      discountType: body.discountType,
      validTill: body.validTill,
      numOfDays: body.numOfDays,
      itemCategories: body.itemCategories,
      minItemCount: body.minItemCount,
      discountPrice: body.discountPrice,
      totalRedemptions: body.totalRedemptions,
      id: body.id,
      isCategoryMenuOpen: body.isCategoryMenuOpen
    })
  }

  getAllCampaigns(){
    return this.api.get(`list_campaign`)
  }

  updateCampaign(body){
    return this.api.post(`update_campaign/${body.id}`, {
      campaignName: body.campaignName,
      discountType: body.discountType,
      validTill: body.validTill,
      numOfDays: body.numOfDays,
  ...
  deleteCampaign(id){
    return this.api.get(`delete_campaign/${id}`)
  }
